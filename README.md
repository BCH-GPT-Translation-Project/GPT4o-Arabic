...
This Arabic-specific work is currently in the publishing process.
...
1. Create a `Translation Units.xlsx` document in the active directory with the following format:
    ...
    | translation001 | Arabic | 343 | Whole | T1 | T2 | 20240802 | 365 | 348 |
    | translation002 | Arabic | 366 | Partial | T2 | T1 | 20240802 | 389 | 376 |
    | translation003 | Arabic | 752 | Whole | T1 | T2 | 20240802 | 781 | 749 |
